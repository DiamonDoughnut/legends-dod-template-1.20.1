...
public enum ModArmorMaterials implements ArmorMaterial {
    LEGEND("legend", 25, new int[] {3, 8, 6, 3}, 50, SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 3f, 2f, () -> Ingredient.ofItems(ModItems.LEGENDSHARD))
    ...
    public String getName() {
        return LegendsDoD.MOD_ID + ":" + this.name;
    }
